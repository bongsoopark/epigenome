...
254 sequence specific TFs were derived from Cis-BP database. Most eukaryotic genes are also regulated by specific transcription factors. These specific transcription factors control the transcription of specific target genes (not all of the genes in the genome). Why are specific transcription factors needed? For many genes, general transcription factors alone are not enough (will not cause much transcription). Instead, the right set of specific transcription factors must also be present to put the gene in its "on" state. This means the gene is expressed only under certain conditions, which are signaled by the specific transcription factors. A typical specific transcription factor is a DNA-binding protein that recognizes a target DNA sequence. Wherever it finds this sequence, the transcription factor will bind to the DNA. The bound transcription factor affects binding of RNA polymerase at a nearby (or sometimes, not-so-nearby!) promoter. [www.khanacademy.org]
%%!endif%%
%%!if($class=="cm")%%
